...
#endif
#if !__MICROSPLAT_TERRAINMESH__
         modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-mesh-terrains-157356&pubref=1011l37NJ", "microsplat_module_terrainmesh"));
#endif

         if (modules.Count > 1)
         {
            modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-lwrp-urp-support-117808&pubref=1011l37NJ", "microsplat_module_urp"));
            modules.Add(new Module("https://assetstore.unity.com/packages/tools/terrain/microsplat-hdrp-support-157242&pubref=1011l37NJ", "microsplat_module_hdrp"));
         }
